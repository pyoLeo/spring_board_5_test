...
<body>
	...
	<script src="ehopper/js/jquery.js"></script>
	<script src="ehopper/js/price-range.js"></script>
	<script src="ehopper/js/jquery.scrollUp.min.js"></script>
	<script src="ehopper/js/bootstrap.min.js"></script>
	<script src="ehopper/js/jquery.prettyPhoto.js"></script>
	<script src="ehopper/js/main.js"></script>
</body>
</html>