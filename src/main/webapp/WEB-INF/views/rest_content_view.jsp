...
<body>
   <table id="list-table" width="500" cellpadding="0" cellspacing="0" border="1">
      <form id="updateForm" action="${pageContext.request.contextPath}/restful/board/${content_view.bId}" method="post">
         ...
         <tr >
            <td colspan="2"> <input type="submit" value="수정"> &nbsp;&nbsp; <a href="${pageContext.request.contextPath}/restful/board">목록보기</a> &nbsp;&nbsp; <a id="a-delete">삭제</a> &nbsp;&nbsp; <a href="${pageContext.request.contextPath}/restful/board/reply/${content_view.bId}" id="reply">답변</a></td>
         </tr>
      </form>
   </table>
